    ...
    <section className="py-20 section-gradient">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl p-8 mb-12 shadow-card">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="p-6 bg-primary/5 border-primary/20">
                ...
                <div className="text-2xl font-bold text-primary mb-2">$1,750</div>
                <p className="text-sm text-muted-foreground">each</p>
              </Card>
            </div>
          </div>

          <div className="bg-white rounded-xl p-8 mb-12 shadow-card">
          ...
          <Button size="lg" className="text-xl px-12 py-6 bg-primary text-white hover:bg-primary/90 shadow-button">
